export const adminCopy = {
  ...
  reservas: {
    ...
    touristSearchPlaceholder: 'Busca por nombre o teléfono...',
    touristSearchHint: 'Escribe al menos 2 caracteres.',
    touristNoResults: 'No se encontraron turistas registrados con ese nombre o teléfono.',
    touristChange: 'Cambiar',
    serviceLabel: 'Servicio',
    servicePlaceholder: '— Selecciona un servicio —',
    guideTourLabel: 'Tour',
    guideTourPlaceholder: '— Selecciona un tour —',
    submit: 'Registrar reserva',
    submitting: 'Registrando...',
    success: 'Reserva registrada. Se notificó al proveedor por correo.',
    errors: {
      touristRequired: 'Selecciona un turista.',
  ...
  negocios: {
    ...
    form: {
      ...
      phone: 'WhatsApp del negocio',
      phonePlaceholder: 'Ej: 3001234567 (el mismo número donde reciben pedidos)',
      owner: 'Propietario',
