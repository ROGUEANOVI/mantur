    ...
    <div className="rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow bg-card border border-border flex items-center gap-3 p-3">
      ...
      <div className="flex-1 min-w-0 py-1">
        <div className="flex items-center gap-2 flex-wrap mb-0.5">
          <h3 className="font-semibold text-foreground text-sm leading-snug">{place.name}</h3>
          <span className={cn('bg-secondary text-secondary-foreground', 'text-xs font-medium px-2 py-0.5 rounded-full shrink-0')}>
            {typeLabel}
          </span>
        </div>
        {place.description && (
